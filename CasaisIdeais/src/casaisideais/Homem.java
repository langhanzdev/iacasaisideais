...
public class Homem {
    ...
    public Homem(int id, int preferencia1, int preferencia2, int preferencia3) {
        this.id = id;
    ...
    public String toString() {
        return "Homem{" + "id=" + id + ", preferencia1=" + preferencia1 + ", preferencia2=" + preferencia2 + ", preferencia3=" + preferencia3 + '}';
    }
